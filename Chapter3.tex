...
Because of the reasons above, this thesis proposes building a \textbf{Social media platform for security}. This platform serves as a place where users can interact with each other, as well as allows people to contribute their knowledge to the system via crowdsourcing. Aside \\
\begin{center}
    \begin{figure}[H]
    \centering
