...
\begin{center}
	...
	\end{figure}
\end{center}
\footnotetext{Source:\url{https://www.researchgate.net/publication/302595416-Artificial-Neural-Network-Model-for-Rainfall-Runoff--A-Case-Study}}
\vspace{-1cm}
...
\begin{center}
	\begin{figure}[H]
		...
		\footcaption{Some examples of Softmax input and output}
		\label{chap2:softmax}
		%https://machinelearningcoban.com/2017/02/17/softmax/
	\end{figure}
\end{center}
\footnotetext{Source: \url{https://machinelearningcoban.com/2017/02/17/softmax}}
\vspace{-1cm}
...
\begin{center}
	\begin{figure}[H]
		...
		\footcaption{\textbf{Left:} Standard Neural Network with 2 hidden Layers. \textbf{Right:} An example of Dropout}
		%https://hackernoon.com/is-the-braess-paradox-related-to-dropout-in-neural-nets-270ecb97cdeb
		\label{chap2:dropout}
	\end{figure}
\end{center}
\footnotetext{Source:\url{https://hackernoon.com/is-the-braess-paradox-related-to-dropout-in-neural-nets-270ecb97cdeb}}
\vspace{-1cm}
...
\begin{center}
  ...
  \footcaption{Simple Convolution Neural Network Architecture}
  \label{chap2:CNN arch}
  \end{figure}
\end{center}
\footnotetext{Source:\url{https://web.math.princeton.edu/~mw25/files/MWeber-PICSciE-talk.pdf}}
\vspace{-1cm}
...
\begin{itemize}
	...
	\begin{center}
		\begin{figure}[H]
			...
			\footcaption{Local connectivity in Convolution Neural Network}
			\label{chap2:LocalConnectivity}
		\end{figure}
	\end{center}
\footnotetext{Source: \url:{http://cs231n.stanford.edu/slides/2018/cs231n-2018-lecture05.pdf}}
	\vspace{-1cm}
...
\begin{center}
  ...
  \footcaption{Output volume with F = 3, W = 5, S = 1 and Zero-Padding P = 1 }
...
\begin{center}
  ...
  \footcaption{Max Pooling and Average Pooling}
  \label{chap2:MaxPooling and Average Polling}
  \end{figure}
\end{center}

\footnotetext{Source: \url:{https://towardsdatascience.com/a-deeper-understanding-of-nnets-part-1-cnns-263a6e3ac61}}
\vspace{-1cm}
...
\begin{center}
  ...
  \footcaption{LeNet Architecture}
  \label{chap2:WSP}
  \end{figure}
\end{center}
\footnotetext{Source: \url:{https://www.coursera.org/lecture/convolutional-neural-networks/classic-networks-MmYe2}}
\vspace{-1cm}
...
\begin{center}
  ...
  \footcaption{AlexNet Architecture}
  \label{chap2:WSP}
  \end{figure}
\end{center}
\footnotetext{Source: \url:{https://www.coursera.org/lecture/convolutional-neural-networks/classic-networks-MmYe2}}
...
\begin{center}
  ...
  \footcaption{GoogleNet Architecture}
  \label{chap2:WSP}
  \end{figure}
\end{center}

\footnotetext{Source: \url:{https://medium.com/@sidereal/cnns-architectures-lenet-alexnet-vgg-googlenet-resnet-and-more-666091488df5}}
\vspace{-1cm}
...
\begin{center}
  ...
  \footcaption{VGG Architecture}
  \label{chap2:WSP}
  \end{figure}
\end{center}
\footnotetext{Source: \url:{http://cs231n.stanford.edu/slides/2017/cs231n-2017-lecture9.pdf}}
\vspace{-1cm}
...
\begin{center}
  ...
  \end{figure}
\end{center}
\footnotetext{Source: \url:{https://towardsdatascience.com/an-overview-of-resnet-and-its-variants-5281e2f56035}}
\vspace{-1cm}
...
\begin{center}
  ...
  \footcaption{Hadamard multiplication}
  \label{chap2:WSP}
  \end{figure}
\end{center}
\footnotetext{Source: \url{https://towardsdatascience.com/linear-algebra-cheat-sheet-for-deep-learning-cd67aba4526c}}
\vspace{-1cm}
