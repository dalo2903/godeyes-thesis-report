...
\Huge
	\begin{tabular}{@{}c}
		\bfseries{A System to Collect and Analyze Image/Video Data using} \\		
		\bfseries{Crowdsourcing Model and Deep Learning } \\
		\bfseries{Techniques for Social Security} \\[0.5cm]
