...
\textbf{Receive and save data}//
\textbf{Label video}//
\textbf{Notify user about anomaly}//

\subsubsection{Labeling of Videos}
...
\begin{center}
    \begin{figure}[H]
    \centering
    \includegraphics[width=1\columnwidth]{images/chap4/createpostflowchart.png}
    \end{figure}
\end{center}
