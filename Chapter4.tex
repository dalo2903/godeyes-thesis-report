...
\begin{itemize}
	...
	\item Location Controller: This controller contains two parts: location and location subscriber. The location part manipulates location. It controls in which condition a location will be created. Each user has a list of subscriber location and will get notified of suspicious warning.
	\item Notification Controller: handle the way notification sent to users and what notification has been seen by the user.
