...
\item Person: is an object which includes its identity (Person ID), a bunch of Persisted Face, and other related data.
\item Person Group: is a set of Persons and is the unit of Identification.
\item Person Group - Create:
\item Person Group - Train:
\item Person Group Person – Create:
\item Person Group Person – Add Face:
